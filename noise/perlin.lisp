    ...
    (multiple-value-bind (hash-x hash-y) (bs-fast32-hash-2-per-corner pi)
      (let* ((grad-x (- hash-x (v4! "0.49999")))
        ...
        (let* ((dotval
          ...
          (* results "1.4142135623730950488016887242097"))))))
      ...
      (let* ((grad-x (- hash-x (v4! "0.49999")))
             ...
             (grad-results
              (* (inversesqrt (+ (* grad-x grad-x) (* grad-y grad-y)))
                 (+ (* grad-x (s~ pf-pfmin1 :xzxz))
                    (* grad-y (s~ pf-pfmin1 :yyww))))))
        (multf grad-results (v4! "2.3703703703703703703703703703704"))
      ...
      (let* ((grad-x (- hash-x (v4! "0.49999")))
        ...
        (let* ((grad-results
          ...
          (let* ((m2 (* m m))
                 ...
                 (final-normalization "2.3703703703703703703703703703704"))
  ...
  (let* ((pi (floor p))
    ...
    (multiple-value-bind (hashx0 hashy0 hashz0 hashx1 hashy1 hashz1)
      ...
      (let* ((grad-x0 (- hashx0 (v4! "0.49999")))
        ...
        (multf final "1.1547005383792515290182975610039")
        final))))
          ...
          (let* ((dotval-0
            ...
            (incf (w result)
                  (dot
                   ...
                   (v4! (z blend-deriv))))
            (multf result (v4! "1.1547005383792515290182975610039"))
            result))))))
               ...
               (final
                (+
                 ...
                 (dot
                  ...
                  grad-results-1))))
          (multf final "2.3703703703703703703703703703704")
          final)))))
